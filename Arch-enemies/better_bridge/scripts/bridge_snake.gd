...
func _init():
	...
	attach_cells = [
		BridgeCell.new(Vector2i(3,0), TileType.Variants.FORBIDDEN),
		BridgeCell.new(Vector2i(3,1), TileType.Variants.FORBIDDEN),
		BridgeCell.new(Vector2i(3,-1), TileType.Variants.FORBIDDEN),
		BridgeCell.new(Vector2i(2,1), TileType.Variants.FORBIDDEN),
		BridgeCell.new(Vector2i(2,-1), TileType.Variants.FORBIDDEN),
		
		BridgeCell.new(Vector2i(1,-1), TileType.Variants.HORIZONTAL),
		BridgeCell.new(Vector2i(0,-1), TileType.Variants.HORIZONTAL),
		BridgeCell.new(Vector2i(-1,-1), TileType.Variants.HORIZONTAL),
		BridgeCell.new(Vector2i(-1,-1), TileType.Variants.HORIZONTAL),
		BridgeCell.new(Vector2i(-2,-1), TileType.Variants.HORIZONTAL),
		
		BridgeCell.new(Vector2i(1,1), TileType.Variants.VERTICAL),
		BridgeCell.new(Vector2i(0,1), TileType.Variants.VERTICAL),
		BridgeCell.new(Vector2i(-1,1), TileType.Variants.VERTICAL),
		BridgeCell.new(Vector2i(-1,1), TileType.Variants.VERTICAL),
		BridgeCell.new(Vector2i(-2,1), TileType.Variants.VERTICAL),
		BridgeCell.new(Vector2i(-3,1), TileType.Variants.VERTICAL),
	]
