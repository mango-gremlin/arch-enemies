...
@onready var bridge_level_scenes: Dictionary = {
	BridgeEdge.new(0,1): "res://bridges/scenes/levels/0_TutorialLevel.tscn",
	BridgeEdge.new(1,2): "res://bridges/scenes/levels/1_FrogHazardLevel.tscn",
	BridgeEdge.new(1,3): "res://bridges/scenes/levels/2_FinalLevel.tscn"
} 
...
@onready var npc_dialogues: Dictionary = {
	...
	1 : OverworldDialogues.dialogue_snake_stefan(),
	2 : OverworldDialogues.dialogue_spider_grandpa(),
	3 : OverworldDialogues.dialogue_squirrel_egg(),
	4 : OverworldDialogues.dialogue_squirrel_ol_nutter(),
	5 : OverworldDialogues.dialogue_starting_conflict(),
	6 : OverworldDialogues.dialogue_final()
}
